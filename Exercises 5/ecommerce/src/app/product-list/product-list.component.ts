...
export class ProductListComponent {
  ...
  constructor() {
    ...
    this.products = [
      ...
      new Product(2, "Bear", "https://m.media-amazon.com/images/I/91oxSXgVD6L._AC_UF894,1000_QL80_.jpg", 3, false),
      new Product(3, "Car", "https://cdn.ecommercedns.uk/files/9/253379/1/28429561/07-10141r-01-toy-mercedes-c-class-red-kids-12v-electric-sit-in-v.jpg", 1.5, true)
    ]
  }
